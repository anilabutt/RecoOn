...
public class Dijkstra {
   ...
   public static void main(String[] args) {
	   	...
	   	MinimumPathMap minimum_path_map_class = MinimumPathMap.getDefaultMap();
	   	PrimaryTreeMap<String, HashMap<String, HashMap<String,ArrayList<String>>>> minimum_pathsMap = minimum_path_map_class.get_classConnectivity_Value();

	   	CorpusDataRetrieval retrieval = new CorpusDataRetrieval();
			
		ArrayList<String> ontologies = retrieval.getExistingLoadedOntology();
		HashMap<String, HashMap<String, ArrayList<String>>> paths = new HashMap<String, HashMap<String, ArrayList<String>>>();
		
		try { 
			for(int count=262; count<263; count++) {
...
//	   }
   ...
   public static HashMap<String, HashMap<String, ArrayList<String>>> getMinimumPathsForOntology(String ontology) {

	   HashMap<String, HashMap<String, Double>> map = createConnectionMatrix(ontology);
//	   System.out.println("createConnectionMatrix  : " + map);

	   HashMap<String, HashMap<String, ArrayList<String>>> miniPaths = new HashMap<String, HashMap<String, ArrayList<String>>>();
		  ...
		  // System.out.println( "FROM getMinimumPathsForOntology   "  + classURI);
		   ...
		   Graph g = new Graph(GRAPH);
			...
			if (g.dijkstra(START)==-1)  {
				...
				HashMap<String, ArrayList<String>> miniPathOfClass = new HashMap<String, ArrayList<String>>();
