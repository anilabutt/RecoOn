...
public class MinimumPathMapLength {
	
	private static MinimumPathMapLength defaultMap;
	public PrimaryTreeMap<String, HashMap<String, HashMap<String,Double>>> minimum_paths;
	public RecordManager recMan;

	
	public static MinimumPathMapLength getDefaultMap() {
		if(defaultMap==null) {
			defaultMap = new MinimumPathMapLength();
		}
		return defaultMap;
	}
	
	private MinimumPathMapLength(){
...
//		//System.out.println(fileName);
	...
	public void save_minimum_path_Value(String ontologyId , HashMap<String, HashMap<String,Double>> ontologyTfIdfs) {
...
//		    System.out.println("Saved for : " + ontologyId);
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
