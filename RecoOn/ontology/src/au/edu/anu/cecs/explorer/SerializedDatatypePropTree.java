...
public class SerializedDatatypePropTree {

	public void serializeData(TreeNode root) {
		try
	      {
			 String fileName = (((au.edu.anu.cecs.explorer.tree.Resource)root.getUserObject()).uri);
//			 System.out.println("fileName  : "+ fileName);
			 String path= PathString.getPathString();
	         FileOutputStream fileOut = new FileOutputStream(path+ "preCompData/profile/property/datatype/tree/"+fileName+".ser");
...
//	    	  System.out.println(fileName);
	    	  String path= PathString.getPathString();
	         FileInputStream fileIn = new FileInputStream(path+"preCompData/profile/property/datatype/tree/"+fileName+".ser");
