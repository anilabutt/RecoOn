...
public class SerializedObjectPropTree {
...
//			 System.out.println("fileName  : "+ fileName);
	         ...
	         FileOutputStream fileOut = new FileOutputStream(path + "preCompData/profile/property/object/tree/"+fileName+".ser");
...
//	    	  System.out.println(fileName);
	    	  String path= PathString.getPathString();
	         FileInputStream fileIn = new FileInputStream(path+"preCompData/profile/property/object/tree/"+fileName+".ser");
